...
V zakládací listině služby, je zmíněn jediný KPI, který se věnuje počtu usecase, který je stanoven na dva pilotní usecasy a velmi vágně definované "zvýšení do konce roku", které nedefinuje jasný počet usecasů, kterých je třeba dosáhnout. Pro upřesnění však lze využít řádky \emph{Odhadnutý počet uživatelů využívající službu} a \emph{Odhadnutý počet požadavků za rok}, taktéž ze zakládací listiny. V těch to parametrech je definováno, že počet uživatelů, v tom to případě uživatel = usecase, je odhadován na deset za rok a stejně tak počet požadavků na službu by měl být deset ročně. 

Vzhledem k tomu, že dle reportovacího portálu je v současnosti v provozu jen sedm usecasů, nebylo těchto cílů v roce 2023 dosaženo. Zde je však důležité zmínit, že současnosti se finalizuje práce na několika nových usecasech a tak lze splnění tohoto milníku očekávat v prvním čtvrtletí roku 2024.

Počet žádostí na nový usecase..... Doplnit od p. Švaříčka
